...
const OrderPage = () => {
  ...
  // Handle order with confirmation
  ...
  if (loading)
    return <p className="text-center mt-10">Loading Order Page...</p>;
  if (!meal)
    return (
      <p className="text-center text-red-500 mt-10">Meal not found!</p>
    );
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 mt-8 bg-white shadow-lg rounded-xl border">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full py-3 bg-gradient-to-r from-pink-500 to-red-600 text-white font-bold rounded-full hover:opacity-90 transition"
        >
          Confirm Order
        </button>
      </form>
